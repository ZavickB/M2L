...
<ul>
    ...
    <li class="card border-primary mb-3" style="max-width: 20rem;"> <div class="card-header">Date</div> 
        <div class="card-body">
    ...
    <li class="card border-primary mb-3" style="max-width: 20rem;"> <div class="card-header">Description</div>
        <div class="card-body">
            <div class="card-text"> <?= h($event['description']);?></div>
        </div>  
    </li>
    <li class="card border-primary mb-3" style="max-width: 20rem;"> 
